...
![estimated u of tumor compartment with non-local prior](EOC_U_Laplace.png)
![estimated u of tumor compartment with Laplace prior](EOC_U_Laplace.png)


# Pending tasks:

Then we can seperately run the convolution on the treatment-naïve and post-neoadjuvant chemotherapy data to get $z_n$ for treatment-naïve and $z_p$ for post-neoadjuvant chemotherapy. 
